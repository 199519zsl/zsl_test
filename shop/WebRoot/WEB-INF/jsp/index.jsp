...
<div class="container header">
	<div class="span5">
		<div class="logo">
			<a href="http://book.dangdang.com/?_utm_sem_id=6316609&_ddclickunion=422-kw-4-%CD%BC%CA%E9-%CD%A8%D3%C3%B4%CA%A3%A8%D0%C2%A3%A9_%CD%A8%D3%C3-%B9%BA%CA%E9_%CD%F8%C9%CF+%C2%F2%CA%E9|ad_type=0|sys_id=1">
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/ddlogo.jpg" alt="当当网上书店"/>
			</a>
		</div>
	</div>
	<div class="span9">
						...
						<ul class="tabContent" style="display: block;">
							<s:iterator var="p" value="hList">
									<li>
									    ...
									    <h4  align="center" style="color:green">${p.pname }</h4> 
										<h3  align="center" style="color:red">￥:${p.shop_price }	&nbsp&nbsp&nbsp<del style="color:gray">￥:<s:property value="#p.market_price"/></del></h3> 
									</li>
							</s:iterator>		
						</ul>
...
<div class="container footer">
	...
	<div class="span24">
		<div class="copyright">Copyright © 2005-2017  网上图书销售  版权所有</div>
	</div>
</div>
</body>
</html>