								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="155" valign="bottom"
					                      ...
					                      <!--   <form action="adminProduct_logout.action"><button type="submit">退出</button></form>--> 
										  <strong><a href="${pageContext.request.contextPath}/admin/index.jsp" target="_parent">退出</a></strong>
										</td>
