	...
	<body>
		<br>
			...
			<table cellSpacing="1" cellPadding="0" width="100%" align="center" bgColor="#f5fafe" border="0">
				...
				<tr>
				<td align="center">
				    <form action="${ pageContext.request.contextPath }/adminOrder_findByName.action"> 
                       <input type="text" style="width:160px;height:25px; " class="input w50" name="oname" size="50px" placeholder="请输入收货人"/>
