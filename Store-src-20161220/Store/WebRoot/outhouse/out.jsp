...
<div class="panel admin-panel">
  ...
  <button type="button" style="width:110px; " class="button border-yellow" onclick="window.showModalDialog('<%=basePath %>/outhouse/outgoods.jsp',window,'dialogWidth:1000px;dialogHeight:600px;dialogLeft:200px;dialogTop:200')"><span class="icon-plus-square-o"></span> 出库</button>
  <br/>
  <br/>
  <form  action="<%=basePath%>/OutHouseList.do" method="post"> 
  ...
  <div class="panel-head"><strong class="icon-reorder">出库列表</strong></div>
  <table class="table">
    <tr>
      <td ><font style="font-weight:bold">出 库单号</font></td>
      ...
      <td ><font style="font-weight:bold">出库日期</font></td>
      <td ><font style="font-weight:bold">出库员</font></td>
    </tr>
    
      <%
       //InhouseDao idao = new InhouseDao();
      //  List list  = idao.query();	//
