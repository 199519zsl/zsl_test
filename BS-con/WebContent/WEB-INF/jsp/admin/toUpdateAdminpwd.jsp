...
<body>
    ...
    <form action="admin_updateAdminpwd" method="post">
	    <ul class="forminfo">
	    	<li><label>账&nbsp;&nbsp;&nbsp;号</label><input name="admin.adm_account" onblur="check_acc()" id="acc" type="text" maxlength="10" class="dfinput" /><i id="accTip" style="color: #f00;">请输入5-10个字符</i></li>
