	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				<form action="student_toQueryStudent" method="post">
					<ul class="seachform">
						<li><label>请输入学号/姓名查询</label><input name="keywords"
							type="text" value="${keywords}" maxlength="20" class="scinput" /></li>
						<li><label>&nbsp;</label><input type="button" class="scbtn"
							onclick="this.form.submit();" value="查询" /></li>
					</ul>
				</form>
					...
					<tbody>
						<c:forEach items="${studentList}" var="obj" varStatus="sta">
							<tr>
								...
								<td>${obj.cname}</td>
								<td>${obj.sex}</td>
								<td><a href="course_queryMark?sid=${obj.sid}"
									class="tablelink"> 查询</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
